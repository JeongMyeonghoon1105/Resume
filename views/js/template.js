                ...
                <div class="content-box">
                    <div class="inner-box">
                        ...
                        <form action="" method="post">
                            <p><input class="signin" type="text" name="pwd" placeholder="  ID"></p>
                            <p><input class="signin" type="password" name="pwd" placeholder="  PASSWORD"></p><br>
                            <p><input class="submit-btn" type="submit" value="NEXT"></p>
                        </form>
                    </div>
                </div>
            </body>
